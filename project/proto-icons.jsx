// Icons (24px stroke=1.75 line) and primitives shared across the prototype.
...
const Prio = ({ p, compact }) => {
  ...
  return <span className={c} style={compact ? { padding: '1px 6px', fontSize: 10 } : null}>
