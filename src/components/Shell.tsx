...
import { Icon, Avi } from './Icon';
import { PROPS } from '../store/data';
...
export const Sidebar: React.FC = () => {
  ...
  const counts: Record<string, number> = { inbox: newMsgs, tix: openTix, today: 7, props: PROPS.length };
...
export const Topbar: React.FC<{ crumbs?: any[]; right?: React.ReactNode }> = ({ crumbs = [], right }) => {
